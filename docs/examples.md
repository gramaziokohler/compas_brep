...
- [brep_from_extrusion.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/breps/brep_from_extrusion.py)
...
- [brep_slice.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/breps/brep_slice.py)
- [brep_split.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/breps/brep_split.py)
- [brep_trim.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/breps/brep_trim.py)
- [brep_with_holes.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/breps/brep_with_holes.py)

## Curves

- [curve_from_interpolation.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/curves/curve_from_interpolation.py)
- [curve_from_points.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/curves/curve_from_points.py)
- [curve_divide.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/curves/curve_divide.py)
- [curve_joining.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/curves/curve_joining.py)

## Surfaces

- [surface_from_points.py](https://github.com/gramaziokohler/compas_brep/blob/main/examples/surfaces/surface_from_points.py)
