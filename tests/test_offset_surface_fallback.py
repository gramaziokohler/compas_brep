...
class TestNoDegeneatePlane:
    def test_no_dummy_plane_origin_zero(self, filleted_box_brep):
...
class TestFilletFaceCount:
    def test_filleted_box_has_more_faces_than_plain_box(self, filleted_box_brep):
...
class TestFilletRoundTrip:
    def test_json_round_trip_preserves_face_count(self, filleted_box_brep):
    ...
    def test_json_round_trip_no_dummy_planes(self, filleted_box_brep):
...
class TestExplicitFailure:
    def test_extract_surface_raises_on_failure(self):
